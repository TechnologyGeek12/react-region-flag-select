...
var CustomCountrySelect = function (_Component) {
    _inherits(CustomCountrySelect, _Component);

    function CustomCountrySelect(props) {
        _classCallCheck(this, CustomCountrySelect);

        var _this = _possibleConstructorReturn(this, (CustomCountrySelect.__proto__ || Object.getPrototypeOf(CustomCountrySelect)).call(this, props));
        ...
        _this.state = { selectedCountry: selectedCountryCode ? selectedCountryCode.id : '', dropData: { data: selectedCountryCode ? selectedCountryCode.name : 'select a country', flag: flagData ? flagData : null, phoneCode: selectedCountryCode ? selectedCountryCode.phoneCode : null }, countries: customCountries.length ? customCountries : countries.countries };

        return _this;
    }

    _createClass(CustomCountrySelect, [{
        key: 'render',
